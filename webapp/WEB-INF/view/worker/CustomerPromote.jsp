...
<title>Customer Promote Page</title>
</head>
<body>
	<header class="header">
		...
		<main class="update">
			<article>
				<table
					...
					<tr>
						<th>Grade</th>
						<td><select id='grade' name="grade" style="height:30px; width:100px; font-size:20px;">
								<option value="${customer.grade}"></option>
								<option value='도라지'>도라지</option>
								<option value='인삼'>인삼</option>
								<option value='산삼'>산삼</option>
						</select></td>	
					</tr>
					<tr>
						<th>Point</th>
						<td><input type="text" name="point" value="${customer.point}"
							/></td>
					</tr>
				</table>
				<div style="align-item: center; margin: 10px 0 0 50px;">
					<input style="background-color: #FFF0F5; border-color: #FFF0F5;"
						...
						type="reset" value="취소" onclick="location.href='management'" />
				</div>
			</article>
		</main>
	</form>
