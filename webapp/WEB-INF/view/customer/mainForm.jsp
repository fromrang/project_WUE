...
<body>
	<form action="" name='form'>
		<!-- <div>
			<img src="/WUE/img/광고.PNG" style="width: 100%; height: 650px;">
		</div> -->
		<div class="content slick-slide" style="background-image: url(/WUE/img/mainad.jpg); width: 100%; height: 600px;" data-slick-index="6" aria-hidden="true" tabindex="-1">
				...
				<c:forEach var="product" items="${products}">
					<li class="cunit_t232">
						<div class="cunit_prod">
							<img src="/WUE/img/Simage/${product.url}"
...
<%-- 									<input type="button" value="좋아요 취소"
		...
		<div class="recommend">
			...
			<div class="ad" style="float: left;">
				<img style="margin-left:150px; width:600px" src="/WUE/img/mainadd2.jpg">
			</div>

			<div class="recommend_detail" >
				<ul class="cunit_thmb_lst" style="margin: 0px;">
					<c:forEach var="Rproduct" items="${Rproducts}">
						<li class="cunit_t232" style="padding: 10px 20px 40px 10px;">
							<div class="cunit_prod">
								...
								<c:when test="${Rproduct.like eq 'Exist'}">
									...
									<!-- //좋아요한 상품 -->
									<i class="fas fa-heart fa-xl" onclick="disLike(${Rproduct.pseq})"></i>
										<%-- <input type="button" value="좋아요 취소"
							...
							<div class="cunit_info">
								<div class="title">
									<Strong><c:choose>
										...
										<c:otherwise>
											<a style="font-size: 12px;" href="/WUE/customer/pseq=${Rproduct.pseq}">${Rproduct.name}</a>
										</c:otherwise>
									</c:choose></Strong>
								</div>
